...
const initialState: covidState = {
  data: {
    ...
    lastUpdate: '2021-12-26T08:21:35.000Z',
  },
  country: '',
  dailyData: [
    {
...
export const fetchAsyncGetCountry = createAsyncThunk(
  ...
  async (country: string) => {
    ...
    return { data: data, coutry: country }
  }
)
...
export const selectCount = (state: RootState) => state.covid.country
